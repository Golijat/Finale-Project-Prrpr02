...
Arvika = requests.get("https://api.met.no/weatherapi/locationforecast/2.0/complete?lat=59.516667&lon=13.8", timeout = 10, headers={"User-Agent":"End-Projekt/0.0.1 github.com/Golijat/Finale-Project-Prrpr02"})
print(Arvika)
Arvika = Arvika.json()
